...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/guigu-auth?serverTimezone=UTC");
        ...
        globalConfig.setOutputDir(System.getProperty("user.dir")+"/service-system/src/main/java");    //设置代码生成位置
        globalConfig.setOpen(false);    //设置生成完毕后是否打开生成代码所在的目录
        globalConfig.setAuthor("fosss");    //设置作者
...
//        globalConfig.setIdType(IdType.ASSIGN_ID);   //设置Id生成策略
        ...
        packageInfo.setParent("com.fosss");   //设置生成的包名，与代码所在位置不冲突，二者叠加组成完整路径
        packageInfo.setModuleName("system");
